...
class Studio(models.Model):
    ...
    naver_link = models.CharField(max_length = 200, default='naver_link', blank=True)
    instagram_link = models.CharField(max_length = 200, default='instagram_link', blank=True)
    phone = models.CharField(max_length=50, default='010-0000-0000', blank=True)
    open_time = models.CharField(max_length=50, default='openTime', blank=True)
    close_time = models.CharField(max_length=50, default='closeTime', blank=True)
    ...
    town = models.CharField(max_length=50, default='town', blank=True)
    photoshop = models.IntegerField(choices=PHOTOSHOP_CHOICES, default=0)
    thumbnail = models.CharField(max_length=500, default="url", blank=True)
